...
from cadastro_app.views import CadastroNovoAlunoView, CadastroNovoMonitorView, CadastroNovoProfessorView, CadastroNovaDisciplinaView, CadastroNovoExercicioView, AlunoInfoView
...
urlpatterns = [
    ...
    path('aluno_info/', AlunoInfoView.as_view(), name='aluno_info'), 
]